...
(function() {
	var configm='http://www.dadiyouhui01.cn/app/tool/v1-bdtool.html';
...
allconfig=
{
"baidu":      {'baidulogo':true,'baidulianjie':true,'baidueye':false,'baidutbq':true,'baidujdq':true,'baidueyecolor':'rgba(204,232,207,1)'},
"google":        {},
"so360":        {},
"pingbiurl":     [],
"pingbikw":     [],
...
saallconfig=
{
"baidu":      {'baidulogo':$("#baidulogo").find("input").prop("checked"),'baidulianjie':$("#baidulianjie").find("input").prop("checked"),'baidutbq':$("#baidutbq").find("input").prop("checked"),'baidujdq':$("#baidujdq").find("input").prop("checked"),'baidueye':$("#baidueye").find("input").prop("checked"),'baidueyecolor':$("#baidueyecolor").val()},
"google":        {},
"so360":        {},
...
$("html").bind("DOMNodeInserted",function(e){
 		   ...
 		   if ( $(".Button.Modal-closeButton.Button--plain").length>0 && $(".Popover.AppHeader-menu").length<0 &&  zhihudl==0){
 		   	   zhihudl=1;
